...
namespace OutlookGoogleCalendarSync
{
  ...
  public partial class MainForm : Form
  {
    ...
    private void sync_Start(Boolean updateSyncSchedule = true)
    {
      ...
      while (!syncOk)
      {
        // fuct - suppress annoying MsgBox when we're offline
        //if (failedAttempts > 0 &&
      ...
      checkSyncMilestone(); // fuct - annoying MsgBox ahead!
    }
    ...
    private Boolean synchronize()
    {
      ...
      catch (System.Exception ex)
      {
        ...
        log.Error(ex.StackTrace);
        try { OutlookCalendar.Instance.Reset(); }
        catch { }
        return false;
      }
    ...
    private void checkSyncMilestone()
    {
      ...
      // fuct - Removed annoying messagebox
      //if (isMilestone) {
